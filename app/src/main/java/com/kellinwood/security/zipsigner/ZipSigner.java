...
public class ZipSigner {
	...
	throws IOException, GeneralSecurityException {
        ...
        URL privateKeyUrl = getClass().getResource("/assets/keys/" + name + ".pk8");
        keySet.setPrivateKey(readPrivateKey(privateKeyUrl, null));

        // load the certificate
        URL publicKeyUrl = getClass().getResource("/assets/keys/" + name + ".x509.pem");
        keySet.setPublicKey(readPublicKey(publicKeyUrl));

        // load the signature block template
        URL sigBlockTemplateUrl = getClass().getResource("/assets/keys/" + name + ".sbt");
