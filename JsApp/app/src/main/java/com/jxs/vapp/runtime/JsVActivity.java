...
public class JsVActivity extends VActivity {
	...
	public Object vsuper(String name, Object...args) throws Throwable {
		...
		switch (name) {
			case "addContentView":
				if (args.length==2&&args[0] instanceof View&&args[1] instanceof LayoutParams) {super.addContentView((View) args[0], (ViewGroup.LayoutParams) args[1]);return null;}
			...
			case "navigateUpToFromChild":
				...
				EF(name,args.length);break;
			case "onActionModeFinished":
				if (args.length==1&&args[0] instanceof ActionMode) {super.onActionModeFinished((ActionMode) args[0]);return null;}
				EF(name,args.length);break;
			case "onActionModeStarted":
				if (args.length==1&&args[0] instanceof ActionMode) {super.onActionModeStarted((ActionMode) args[0]);return null;}
				EF(name,args.length);break;
			...
			case "onCreateContextMenu":
				if (args.length==3&&args[0] instanceof ContextMenu&&args[1] instanceof View&&args[2] instanceof ContextMenuInfo) {super.onCreateContextMenu((ContextMenu) args[0], (View) args[1], (ContextMenu.ContextMenuInfo) args[2]);return null;}
				EF(name,args.length);break;
			...
			case "onCreateDialog":
				...
				EF(name,args.length);break;
			case "onCreateNavigateUpTaskStack":
				if (args.length==1&&args[0] instanceof TaskStackBuilder) {super.onCreateNavigateUpTaskStack((TaskStackBuilder) args[0]);return null;}
				EF(name,args.length);break;
			...
			case "onMenuItemSelected":
				if (args.length==2&&args[0] instanceof int&&args[1] instanceof MenuItem) return super.onMenuItemSelected((int) args[0], (MenuItem) args[1]);
				EF(name,args.length);break;
			case "onMenuOpened":
			...
			case "onPrepareDialog":
				...
				EF(name,args.length);break;
			case "onPrepareNavigateUpTaskStack":
				if (args.length==1&&args[0] instanceof TaskStackBuilder) {super.onPrepareNavigateUpTaskStack((TaskStackBuilder) args[0]);return null;}
				EF(name,args.length);break;
			...
			case "onResume":
				...
				EF(name,args.length);break;
			case "onRetainNonConfigurationInstance":
				if (args.length==0) return super.onRetainNonConfigurationInstance();
				EF(name,args.length);break;
			...
			case "onWindowAttributesChanged":
				if (args.length==1&&args[0] instanceof LayoutParams) {super.onWindowAttributesChanged((WindowManager.LayoutParams) args[0]);return null;}
				EF(name,args.length);break;
			case "onWindowFocusChanged":
				...
				EF(name,args.length);break;
			case "onWindowStartingActionMode":
				if (args.length==1&&args[0] instanceof Callback) return super.onWindowStartingActionMode((ActionMode.Callback) args[0]);
				if (args.length==2&&args[0] instanceof Callback&&args[1] instanceof int) return super.onWindowStartingActionMode((ActionMode.Callback) args[0], (int) args[1]);
				EF(name,args.length);break;
			...
			case "sendStickyOrderedBroadcastAsUser":
				...
				EF(name,args.length);break;
			case "setBackDrawable":
				if (args.length==1&&args[0] instanceof BDrawable) {super.setBackDrawable((BDrawable) args[0]);return null;}
				EF(name,args.length);break;
			case "setContentView":
				if (args.length==2&&args[0] instanceof View&&args[1] instanceof LayoutParams) {super.setContentView((View) args[0], (ViewGroup.LayoutParams) args[1]);return null;}
			...
			case "startActionMode":
				if (args.length==2&&args[0] instanceof Callback&&args[1] instanceof int) return super.startActionMode((ActionMode.Callback) args[0], (int) args[1]);
				if (args.length==1&&args[0] instanceof Callback) return super.startActionMode((ActionMode.Callback) args[0]);
				EF(name,args.length);break;
			...
			case "startActivityFromFragment":
				...
				if (args.length==4&&args[0] instanceof Fragment&&args[1] instanceof Intent&&args[2] instanceof int&&args[3] instanceof Bundle) {super.startActivityFromFragment((Fragment) args[0], (Intent) args[1], (int) args[2], (Bundle) args[3]);return null;}
				EF(name,args.length);break;
	...
	public void setBackButtonColor(int color) {
		if (!callFunction(toArray(color))) super.setBackButtonColor(color);
	}
	@Override
	...
	public ActionBar getActionBar() {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref)) return super.getActionBar(); else return (ActionBar) ref.get();
	}
	@Override
	...
	public FragmentManager getFragmentManager() {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref)) return super.getFragmentManager(); else return (FragmentManager) ref.get();
	}
	@Override
	...
	public LoaderManager getLoaderManager() {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref)) return super.getLoaderManager(); else return (LoaderManager) ref.get();
	}
	@Override
	...
	public void onActionModeFinished(ActionMode p0) {
		if (!callFunction(toArray(p0))) super.onActionModeFinished(p0);
	}
	@Override
	public void onActionModeStarted(ActionMode p0) {
		if (!callFunction(toArray(p0))) super.onActionModeStarted(p0);
	}
	@Override
	...
	public void onAttachFragment(Fragment p0) {
		if (!callFunction(toArray(p0))) super.onAttachFragment(p0);
	}
	@Override
	...
	public void onCreateNavigateUpTaskStack(TaskStackBuilder p0) {
		if (!callFunction(toArray(p0))) super.onCreateNavigateUpTaskStack(p0);
	}
	@Override
	...
	public View onCreateView(View p0, String p1, Context p2, AttributeSet p3) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0, p1, p2, p3))) return super.onCreateView(p0, p1, p2, p3); else return (View) ref.get();
	}
	@Override
	public View onCreateView(String p0, Context p1, AttributeSet p2) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0, p1, p2))) return super.onCreateView(p0, p1, p2); else return (View) ref.get();
	}
	@Override
	...
	public boolean onMenuItemSelected(int p0, MenuItem p1) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0, p1))) return super.onMenuItemSelected(p0, p1); else return (boolean) ref.get();
	}
	@Override
	...
	public void onPrepareNavigateUpTaskStack(TaskStackBuilder p0) {
		if (!callFunction(toArray(p0))) super.onPrepareNavigateUpTaskStack(p0);
	}
	@Override
	...
	public Object onRetainNonConfigurationInstance() {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref)) return super.onRetainNonConfigurationInstance(); else return (Object) ref.get();
	}
	@Override
	...
	public ActionMode onWindowStartingActionMode(ActionMode.Callback p0) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0))) return super.onWindowStartingActionMode(p0); else return (ActionMode) ref.get();
	}
	@Override
	public ActionMode onWindowStartingActionMode(ActionMode.Callback p0, int p1) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0, p1))) return super.onWindowStartingActionMode(p0, p1); else return (ActionMode) ref.get();
	}
	@Override
	...
	@Override
	public void setBackDrawable(Drawable p0) {
		if (!callFunction(toArray(p0))) super.setBackDrawable(p0);
	}
	@Override
	...
	public ActionMode startActionMode(ActionMode.Callback p0, int p1) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0, p1))) return super.startActionMode(p0, p1); else return (ActionMode) ref.get();
	}
	@Override
	public ActionMode startActionMode(ActionMode.Callback p0) {
		JsObjectRef ref=newJsRef();
		if (!callFunction(ref, toArray(p0))) return super.startActionMode(p0); else return (ActionMode) ref.get();
	}
	@Override
	...
	public void startActivityFromFragment(Fragment p0, Intent p1, int p2, Bundle p3) {
		if (!callFunction(toArray(p0, p1, p2, p3))) super.startActivityFromFragment(p0, p1, p2, p3);
	}
	@Override
