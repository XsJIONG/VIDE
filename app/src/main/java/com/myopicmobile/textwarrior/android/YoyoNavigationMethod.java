...
public class YoyoNavigationMethod extends TouchNavigationMethod {
	...
	private static int CaretColor=0xFFFF5500;
	public static void setCaretColor(int c) {
		CaretColor=c;
	}
	public static int getCaretColor() {
		return CaretColor;
	}
	@Override
	public void onColorSchemeChanged(ColorScheme colorScheme) {
		// TODO: Implement this method
		if (_yoyoStart != null) _yoyoStart.setHandleColor(CaretColor);
		if (_yoyoEnd != null) _yoyoEnd.setHandleColor(CaretColor);
		_yoyoCaret.setHandleColor(CaretColor);
	}
